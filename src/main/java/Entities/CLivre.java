...
public class CLivre {
    ...
    public CLivre(int idLivre, String titreLivre, String synopsisLivre, int nombrePagesLivre, int isbn, int anneePublicationLivre, String validationLivre, CVignette vignette, CEditeur editeur, CLangue langue) {
        setIdLivre(idLivre);
