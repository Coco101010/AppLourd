...
public class CTableTelecharge {
    ...
    protected ArrayList<CTelecharge> listTelechargments;
    protected CBDD bdd;

    //Getter et Setter CTableTelecharge

    public ArrayList<CTelecharge> getListTelechargments() {
        return listTelechargments;
    }

    public void setListTelechargments(ArrayList<CTelecharge> listTelechargments) {
        this.listTelechargments = listTelechargments;
    }
